...
const Privacy = () => {
  return <Box pb={70} pos="relative" mih="100vh">
    <Card w="100%" withBorder shadow="sm" p="xs" mb="md">
    ...
    <Box maw={960} m="0 auto" w="100%" px={{ base: 'xs', sm: 'md' }}>
      <main>
        <Paper shadow='none' p='xs' mb='xl' bg="#f1f3f5">
          <Text fs='italic'>
            TLDR: I use a self-hosted version of{' '}
            <a href='https://umami.is/'>umami</a> for anonymised usage tracking and nothing more.<br/>
            Your progress is stored in a MongoDB. It gets referenced by an ID in your local storage. If you create an account I will link a username and an email to your data.
          </Text>
        </Paper>
        ...
        <>
          ...
          <p>
            Vincent Will (&#39;us&#39;, &#39;we&#39;, or &#39;our&#39;) operates
            the https://puzzler.fun website (hereinafter referred to as the
            &#39;Service&#39;).
          </p>
          <p>
            ...
            Vincent Will is created with the help of the{' '}
          ...
          <p>
            ...
            as in our Terms and Conditions, accessible from https://puzzler.fun
          </p>
          ...
          <h2>Use of Data</h2>
          <p>Vincent Will uses the collected data for various purposes:</p>
          <ul>
          ...
          <p>
            Vincent Will will take all steps reasonably necessary to ensure that
          ...
          <p>
            Vincent Will may disclose your Personal Data in the good faith belief
            that such action is necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of Vincent Will</li>
            <li>
          ...
          <ul>
            <li>
              ...
              <p>
                Umami is a web analytics service. Umami does not use any cookies
                in the tracking code. It does not collect any personally
                identifiable information and anonymizes all data collected.
              </p>
            </li>
          </ul>
          ...
          <p>
            ...
            please contact me. If we become aware that we have collected Personal
